...
public class ProductServiceProtobufApplication {

  private static final Logger LOG = LoggerFactory.getLogger(ProductServiceProtobufApplication.class);

  public static void main(String[] args) {
    ConfigurableApplicationContext ctx = SpringApplication.run(ProductServiceProtobufApplication.class, args);
