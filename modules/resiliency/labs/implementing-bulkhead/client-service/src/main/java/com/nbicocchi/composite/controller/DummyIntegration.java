...
public class DummyIntegration {
    ...
    private static final String SLOW_CALL_SERVICE_URL = "http://dummy:8081/slowCall";
    ...
    @Bulkhead(name = "slowCall")
    public String slowCall() {
        URI url = UriComponentsBuilder.fromUriString(SLOW_CALL_SERVICE_URL).build().toUri();
