...
assertEqual "No product found with ID: $PROD_ID_NOT_FOUND" "$(echo $RESPONSE | jq -r .message)"
...
assertCurl 200 "curl -s  http://$HOST:$PORT/swagger-ui/index.html"
assertCurl 200 "curl -sL http://$HOST:$PORT/swagger-ui/index.html"
assertCurl 200 "curl -s  http://$HOST:$PORT/swagger-ui/index.html?configUrl=/v3/api-docs/swagger-config"
#assertCurl 200 "curl -s  http://$HOST:$PORT/swagger-ui/index.html/v3/api-docs"
