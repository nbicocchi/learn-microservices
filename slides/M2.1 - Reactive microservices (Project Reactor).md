...
While the cloud provides outstanding facilities for the infrastructure layer, it covers only half of the story. The second half is your application. It needs to be designed to be a part of a distributed system. It needs to understand the challenges of being part of such a system. This emerging notion has been coined reactiveness and the set of properties that constitute reactive systems has been defined in the [reactive manifesto](https://www.reactivemanifesto.org/). 

The main characteristics are: **responsiveness, resiliency, elasticity, and being message-driven**. 
* **Responsive**: The system focus on providing rapid and consistent response times, establishing reliable upper bounds so they deliver a consistent quality of service.
* **Resilient**: The system stays responsive in the face of failure.
* **Elastic**: The system stays responsive under varying workload.
* **Message Driven**: The system rely on asynchronous message-passing to establish a boundary between components that ensures loose coupling, isolation and location transparency.
