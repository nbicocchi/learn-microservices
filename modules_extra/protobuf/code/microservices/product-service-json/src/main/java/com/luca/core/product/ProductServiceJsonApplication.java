...
public class ProductServiceJsonApplication {

    private static final Logger LOG = LoggerFactory.getLogger(ProductServiceJsonApplication.class);

    public static void main(String[] args) {
        ConfigurableApplicationContext ctx = SpringApplication.run(ProductServiceJsonApplication.class, args);
